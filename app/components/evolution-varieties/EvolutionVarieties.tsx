								...
								<article>
									<Link href={`/pokemon/${evolution.name}`} className="sprite-link">
										<div className="pokemon-img-wrapper">
											<Sprites sprites={[{src: evolution.sprites.front_default, alt: `${evolution.name} sprite`}, {src: evolution.sprites.front_shiny, alt: `${evolution.name} shiny sprite`}]} name={evolution.name} height={100} width={100} />
										</div>
							...
							<li key={index}>
								<article key={index}>
									<Link href={`/pokemon/${variety.id}`} className="sprite-link">
										<div className="pokemon-img-wrapper">
											<Sprites sprites={[{src: variety.sprites.front_default, alt: `${variety.name} sprite`}, {src: variety.sprites.front_shiny, alt: `${variety.name} shiny sprite`}]} name={variety.name} height={100} width={100} />
										</div>
										<h3>{variety.name}</h3>
									</Link>
								</article>
